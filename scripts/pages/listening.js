    ...
    function loadQuestion(idx) {
        ...
        playAudioBtn.onclick = () => {
            if ('speechSynthesis' in window) {
                ...
                utterance.onend = () => { audioStatus.innerText = "✅ Selesai diputar. Silakan pilih jawaban."; };
                
                window.speechSynthesis.speak(utterance);
            } else {
                alert("Browser tidak mendukung pemutaran suara.");
            }
        };
    ...
    nextBtn.onclick = () => {
        ...
        if (currentRound < quizItems.length) {
            ...
            if (window.updateGlobalScore) {
                window.updateGlobalScore('listening', score);
            }
